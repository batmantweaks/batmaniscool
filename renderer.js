...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const tuningProfiles = {
    extreme: ['game-mode', 'hags', 'dynamic-tick', 'power-throttling', 'visual-fx', 'core-parking', 'mouse-accel', 'game-dvr', 'network-throttling', 'gaming-responsiveness', 'usb-selective-suspend', 'pcie-link-state', 'processor-boost', 'tcp-ack-profile', 'high-performance-gpu', 'network-adapter-power', 'cpu-minimum-state', 'active-cooling', 'disk-idle-timeout', 'game-bar-overlay', 'fullscreen-optimizations', 'game-bar-tips', 'game-dvr-audio', 'capture-cursor', 'captured-cursor-border', 'mouse-click-lock', 'mouse-snap-default', 'keyboard-repeat-speed', 'desktop-menu-delay', 'mouse-hover-delay', 'menu-animation', 'edge-background', 'copilot-policy', 'background-apps', 'windows-widgets', 'search-highlights', 'transparency'],
    balanced: ['game-mode', 'hags', 'power-throttling', 'mouse-accel', 'game-dvr', 'gaming-responsiveness', 'processor-boost', 'high-performance-gpu', 'game-bar-overlay', 'game-bar-tips', 'game-dvr-audio', 'desktop-menu-delay', 'mouse-click-lock', 'background-apps', 'windows-widgets'],
